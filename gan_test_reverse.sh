...
WORKPATH=/usr/bmicnas02/data-biwi-01/klanna_data/results/MIC-gan/reverse/

NAME=$1
DATAPATH="/itet-stor/klanna/bmicdatasets_bmicnas02/Sharing/klanna/cyclegan/$1/trainB"
CKPTDIR="/usr/bmicnas02/data-biwi-01/klanna_data/results/MIC-gan/"

# net='latest_net_G_B.pth'
